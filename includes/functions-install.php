 ...
 *
 * Since 1.11 the table structure is created by running the Doctrine migrations in includes/Migrations,
 * rather than by a list of CREATE TABLE statements inlined here. The same work is available from the
 * command line with `php bin/console yourls:install`.
 *
 * @since 1.3
