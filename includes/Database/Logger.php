...
class Logger extends AbstractLogger {
     ...
     *
     * From a query profiled by the DBAL middleware :
     *    $level   : string 'query'
     *    $message : string '' (unused: the message is built here from $context)
     *    $context : array(
    ...
    public function log($level, string|\Stringable $message, array $context = []): void {
        ...
        if($level === 'query') {
            // The calling fetch method is announced by YDB::fetch_wrapper() via the profiler
